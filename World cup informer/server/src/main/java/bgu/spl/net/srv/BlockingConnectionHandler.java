...
public class BlockingConnectionHandler<T> implements Runnable, ConnectionHandler<T> {
    ...
    private final stompMessagingEncoderDecoder <T> encdec;
    ...
    public BlockingConnectionHandler(Socket sock, stompMessagingEncoderDecoder <T> reader, StompMessagingProtocolImpl <T>protocol,Connections <T> connections, int connectionId) {
        this.sock = sock;
        this.encdec = reader;
